...
def main(confirm = None):
    ...
    print(f"\n{BLUE}╔════════════════════════════════════════════╗{NC}")
    print(f"{BLUE}║      YukiOS minimalist sway-dots installer ║{NC}")
    print(f"{BLUE}╚════════════════════════════════════════════╝{NC}\n")
    ...
    pkgs = (
                "sway wget sddm xdg-desktop-portal-wlr wayland wl-clipboard xorg-xwayland "
                "waybar rofi wofi hyprpolkitagent wlogout mako kitty nautilus grim slurp cliphist "
