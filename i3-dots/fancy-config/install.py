...
def main(confirm = None):
    ...
    print(f"\n{BLUE}╔════════════════════════════════════════════╗{NC}")
    print(f"{BLUE}║         YukiOS fancy i3-dots installer     ║{NC}")
    print(f"{BLUE}╚════════════════════════════════════════════╝{NC}\n")
    ...
    if OS_ID == "fedora":
        pkgs = (
            "hyprland wget sddm xdg-desktop-portal-hyprland wayland-devel wl-clipboard xorg-x11-server-Xwayland xorg-x11-server-Xorg "
            ...
            "i3 i3status feh maim xclip picom"
        )
        ...
        pkgs = (
            ...
            "i3-wm i3status feh maim xclip picom"
        )
